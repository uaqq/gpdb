/*-------------------------------------------------------------------------
 *
 * pg_crc32c_power8_clang.h
 *	  Stubs to fix clang incompatibilities with GCC builtins.
 * 
 * IDENTIFICATION
 *	  src/include/port/power8/pg_crc32c_power8_clang.h
 *
 *-------------------------------------------------------------------------
 */
#ifndef PG_CRC32C_POWER8_CLANG_H
#define PG_CRC32C_POWER8_CLANG_H
...
#endif /* PG_CRC32C_POWER8_CLANG_H */
