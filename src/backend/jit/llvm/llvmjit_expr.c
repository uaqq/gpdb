			...
			case EEOP_GROUP_ID:
				{
					...
					v_group_id_p = l_ptr_const(&aggstate->group_id,
											  l_ptr(TypeSizeT));
					v_group_id = l_gep(b, TypeSizeT, v_group_id_p, "v_group_id");
			...
			case EEOP_GROUPING_SET_ID:
				{
					...
					v_gset_id_p = l_ptr_const(&aggstate->gset_id,
											  l_ptr(TypeSizeT));
					v_gset_id = l_gep(b, l_gep, v_gset_id_p, "v_gset_id");
			...
			case EEOP_AGGEXPR_ID:
				{
					...
					v_currentExprId_p = l_ptr_const(&tsstate->currentExprId,
											  l_ptr(TypeSizeT));
					v_currentExprId = l_gep(b, TypeSizeT, v_currentExprId_p, "v_currentExprId");
			...
			case EEOP_ROWIDEXPR:
				{
					...
					v_rowcounter_p = l_ptr_const(rowcounter_p,
												 l_ptr(LLVMInt64Type()));
					v_rowcounter = l_gep(b, LLVMInt64Type(), v_rowcounter_p, "v_rowcounter");
