...
create table t1(a oid primary key);

insert into t1 values ('ao1_srf_test'::regclass::oid);
insert into t1 values ('ao2_srf_test'::regclass::oid);

select * from t1 where a in 
       (select (gp_toolkit.__gp_aoblkdir(t1.a)).row_count 
