 ...
 *
 * pg_crc32c_power8.c
 *	  Compute CRC-32C checksum using IBM POWER8 vector intrinsics.
 *
...
#include "port/power8/pg_crc32c_power8_constants.h"

#if defined (__clang__)
#include "port/power8/pg_crc32c_power8_clang.h"
#else
